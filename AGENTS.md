...
- Main server entrypoint: `cmd/intervals-mcp`; CLI entrypoint: `cmd/intervals`.
- Reuse existing config, Intervals client, and insights layers instead of duplicating API calls: `internal/platform/config`, `internal/adapters/intervalsicu`, `internal/application/insights`.
